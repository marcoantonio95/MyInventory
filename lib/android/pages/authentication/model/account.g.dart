...
mixin _$Account on AccountBase, Store {
  final _$nameAtom = Atom(name: 'AccountBase.name');
  ...
  final _$emailAtom = Atom(name: 'AccountBase.email');
  ...
  final _$passwordAtom = Atom(name: 'AccountBase.password');
  ...
  final _$sectorAtom = Atom(name: 'AccountBase.sector');
  ...
  final _$phoneAtom = Atom(name: 'AccountBase.phone');
  ...
  String toString() {
    final string =
        'name: ${name.toString()},email: ${email.toString()},password: ${password.toString()},sector: ${sector.toString()},phone: ${phone.toString()}';
    return '{$string}';
  }
}
